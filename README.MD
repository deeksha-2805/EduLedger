...
1.  Clone the repository:
    ```bash
    git clone https://github.com/Goldweb-Solutions/Edu-Ledger.git
    ```
2.  Install frontend(root) dependencies:
    ...
    npm install
    ```
3.  Install backend dependencies (Express.js):
    ```bash
    cd backend
    npm install
    ```
...
Run the frontend and backend concurrently in separate terminals.
...
**`0xdf1bf205384af612bd0cb3fa1b7f245fdd522782`**

👉 Take a look at `EduLedger.sol` in the `contracts` directory.

You can view the contract on the [Celo Sepolia Block Explorer](https://celo-sepolia.blockscout.com/address/0xdf1bf205384af612bd0cb3fa1b7f245fdd522782).



## Video
👉 Take a look at `demo.mov` in the `media` directory.
