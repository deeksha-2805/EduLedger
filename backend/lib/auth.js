...
module.exports = { getUserFromCookie, getUserWalletAddress, createAuthToken, verifyAuthToken, getUserById, getUserByWalletAddress, createUser, updateUser, checkUserExists, requireAuth, validateUserPermissions };
